...
create UNIQUE INDEX categ_nick on categories(categ_nick);

-- Создать таблицу для лотов -- 
CREATE TABLE lots(
...
-- Создать индекс для связи с другими таблицами --
